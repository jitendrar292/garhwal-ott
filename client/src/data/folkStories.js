...
const STORIES = [
  ...
  {
    slug: 'khala-ki-chudail',
    name: 'खाला की चुड़ैल',
    blurb: 'आधी रात के दर्रे की कथा — उल्टे पैरों वाली सफेद औरत और यात्रियों की परीक्षा।',
    emoji: '🕯️',
  },
  {
    slug: 'devdar-ka-jhyunta',
    name: 'देवदार का झ्यूंता',
    blurb: 'देवदार जंगल का रूप-बदलू आत्मा जो परिचित आवाज़ बनाकर राह भुला देती है।',
    emoji: '🌲',
  },
  {
    slug: 'masaan-ghat-rahasya',
    name: 'मसान घाट का रहस्य',
    blurb: 'रात के श्मशान किनारे जलती अनदेखी लौ और अधूरी आत्माओं की लोक-मान्यता।',
    emoji: '🔥',
  },
  {
    slug: 'pipal-ka-saya',
    name: 'पीपल का साया',
    blurb: 'गाँव के पीपल तले सांझ के बाद न रुकने की पुरानी चेतावनी पर आधारित कथा।',
    emoji: '🌘',
  },
  {
    slug: 'harda-ka-bugyal',
    name: 'हरदा का बुग्याल',
    blurb: 'एक ग्वाले की पर्वतीय लोक-कथा — ईमान, मेहनत और देवभूमि की करुणा की कहानी।',
    emoji: '🐐',
  },
  {
    slug: 'dholi-ki-shaap-katha',
    name: 'ढोली का श्राप',
    blurb: 'अपमानित लोक-कलाकार के श्राप और पूरे गांव पर पड़े सांस्कृतिक असर की गाथा।',
    emoji: '🥁',
  },
];
