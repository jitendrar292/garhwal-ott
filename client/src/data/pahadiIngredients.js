...
const PAHADI_INGREDIENTS = [
  {
    ...
    online: [
      { label: 'Amazon India', url: 'https://www.amazon.in/s?k=gehat+dal+uttarakhand' },
      { label: 'Flipkart', url: 'https://www.flipkart.com/search?q=gehat+kulath+dal' },
      { label: 'Himalayan Organic', url: 'https://www.amazon.in/s?k=organic+horse+gram+uttarakhand' },
    ],
  ...
  },
  {
    ...
    online: [
      { label: 'Amazon India', url: 'https://www.amazon.in/s?k=bhatt+ki+dal+uttarakhand' },
  ...
  },
  {
    ...
    online: [
      { label: 'Amazon India', url: 'https://www.amazon.in/s?k=mandua+flour+uttarakhand' },
      { label: 'Flipkart', url: 'https://www.flipkart.com/search?q=mandua+ragi+pahadi' },
      { label: 'Organic India', url: 'https://www.amazon.in/s?k=organic+finger+millet+flour' },
    ],
  ...
  },
  {
    ...
    online: [
      { label: 'Amazon India', url: 'https://www.amazon.in/s?k=jakhiya+spice+uttarakhand' },
  ...
  },
  {
    ...
    online: [
      { label: 'Amazon India', url: 'https://www.amazon.in/s?k=jambu+herb+uttarakhand' },
  ...
  },
  {
    ...
    online: [
      { label: 'Amazon India', url: 'https://www.amazon.in/s?k=pahadi+garam+masala+uttarakhand' },
  ...
  },
  {
    ...
    online: [
      { label: 'Amazon India', url: 'https://www.amazon.in/s?k=pahadi+kachi+ghani+mustard+oil' },
  ...
  },
  {
    ...
    online: [
      { label: 'Amazon India', url: 'https://www.amazon.in/s?k=hemp+seeds+uttarakhand' },
  ...
  },
  {
    ...
    online: [
      { label: 'Amazon India', url: 'https://www.amazon.in/s?k=black+urad+dal+whole' },
  ...
  },
  {
    ...
    online: [
      { label: 'Amazon India', url: 'https://www.amazon.in/s?k=organic+sesame+seeds+white' },
