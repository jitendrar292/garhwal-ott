...
const FOOTER_LINKS = [
  ...
  { label: 'सांस्कृतिक पुस्तकालय', path: '/culture' },
      ...
      <div className="relative max-w-full mx-auto px-4 sm:px-6 pt-10 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="flex flex-col items-center md:items-start gap-4">
            ...
            <p className="text-body-sm text-white/40 leading-relaxed text-center md:text-left max-w-xs">
          ...
          <div className="flex flex-col items-center md:items-start gap-3">
            <h3 className="text-caption uppercase tracking-wider text-white/30 font-semibold">
              Quick Links
            </h3>
            <div className="flex flex-wrap justify-center md:justify-start gap-x-4 gap-y-2">
              {FOOTER_LINKS.map((link) => (
                <Link
                  key={link.path}
                  to={link.path}
                  className="text-body-sm text-white/40 hover:text-primary-400 transition-colors duration-200"
                >
                  {link.label}
                </Link>
              ))}
          ...
          <div className="flex flex-col items-center md:items-start gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-body-sm text-white/40 hover:text-primary-400 transition-colors duration-200"
            >
            ...
            <div className="flex items-center gap-2 mt-1">
              <a
                ...
                title="LinkedIn"
                className="w-9 h-9 flex items-center justify-center rounded-xl bg-white/[0.03] border border-white/6 text-white/40 hover:text-white hover:bg-[#0A66C2] hover:border-[#0A66C2] transition-all duration-200"
              >
              ...
              <Link
                ...
                title="Feedback"
                className="w-9 h-9 flex items-center justify-center rounded-xl bg-white/[0.03] border border-white/6 text-white/40 hover:text-primary-300 hover:bg-primary-500/10 hover:border-primary-500/30 transition-all duration-200"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-caption text-white/25 leading-relaxed text-center md:text-left mt-1">
              Built by <a href="https://www.linkedin.com/in/jitendrar-singh-rawat/" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-primary-400 transition-colors">Jitendra Singh Rawat</a>
            </p>
          </div>
        </div>
